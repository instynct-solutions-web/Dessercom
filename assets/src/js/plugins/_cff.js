			...
			if (jQuery('#cff.cff-masonry-js').length) {
				...
				!(function (a) {
					...
					(function (a, b) {
						...
						var h = a.getComputedStyle,
							...
							l = j && k,
							m = !!d('perspective'),
							n = { WebkitTransition: 'webkitTransitionEnd', MozTransition: 'transitionend', OTransition: 'otransitionend', transition: 'transitionend' }[j],
				...
				function cffAddMasonry($self) {
					...
					if (windowWidth > 800) {
						...
						if ($self.hasClass('masonry-2-tablet') || $self.hasClass('masonry-3-tablet') || $self.hasClass('masonry-4-tablet') || $self.hasClass('masonry-5-tablet') || $self.hasClass('masonry-6-tablet')) {
							masonryEnabled = true;
							$self.addClass('cff-masonry cff-masonry-js').removeClass('cff-disable-masonry');
						} else {
							$self.addClass('cff-disable-masonry');
						...
						if ($self.hasClass('masonry-2-mobile') || $self.hasClass('masonry-3-mobile')) {
							masonryEnabled = true;
							$self.addClass('cff-masonry cff-masonry-js').removeClass('cff-disable-masonry');
						} else {
							$self.addClass('cff-disable-masonry');
