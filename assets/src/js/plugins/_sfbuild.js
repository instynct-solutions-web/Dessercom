		...
		(function e(t, n, r) {
		...
		})(
			{
				1: [
						...
						(function ($) {
							...
							$.extend($.easing, {
								...
								easeInOutBounce: function (e, t, n, r, i) {
									if (t < i / 2) return $.easing.easeInBounce(e, t * 2, 0, r, i) * 0.5 + n;
									return $.easing.easeOutBounce(e, t * 2 - i, 0, r, i) * 0.5 + r * 0.5 + n;
								},
							});
						})(jQuery);
					...
					{ './includes/fields': 4, './includes/pagination': 5, './includes/plugin': 6, './includes/state': 8 },
				],
				2: [
					function (require, module, exports) {
						/*!
										...
										if ($date_picker.length > 0) {
											$date_picker.each(function () {
												...
												if (self.lang_code != '') {
													...
													$.datepicker.setDefaults($.extend({ 'dateFormat': dateFormat }, $.datepicker.regional['en']));
												}
											});
								 ...
								 this.copyAttributes($list_from, $list_to);*/
									...
									this.addResults = function (data, data_type) {
										...
										if (self.infinite_scroll_container != '') {
											self.load_more_html = $('<div>' + self.load_more_html + '</div>')
												.find(self.infinite_scroll_container)
												.html();
										}
										if (self.infinite_scroll_result_class != '') {
