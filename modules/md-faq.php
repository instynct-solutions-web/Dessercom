<?php
$faq = $args;
$title = get_the_title($faq['faq']->ID);
$question = get_field('question', $faq['faq']->ID);
$category = get_the_terms($faq['faq']->ID, 'groupe');
?>
<li class="faq__answer faq__answer--closed" data-terms-policies data-faq>
    <span class="faq__hide category"><?= $category[0]->slug ?></span>
